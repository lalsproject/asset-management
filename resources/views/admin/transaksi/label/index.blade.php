...
@section('content')
            ...
            <div class='row'>
                <div class="col-md-12">
                    ...
                    <span class="float-right">
                        <button type="button" class="btn btn-danger" onclick="Kosongkan()">Kosongkan</button>
    ...
    @include('admin.transaksi.label.modal')
...
@section('js')
    <script>
        ...
        function EditData(id, barang_id, kode, deskripsi){
            $('#pesan').html("");
        ...
        function HapusData(id){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.transaksi.cetaklabel.hapusdata') }}',
                        type: 'POST',
                        data: datanya
                    })
                    .then(response => {
        ...
        function HapusTerpilih(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ route('admin.transaksi.cetaklabel.hapusdipilih') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {
        ...
        function Kosongkan(){
            ...
            Swal.fire({
                text: 'Apakah yakin data akan dikosongkan ?',
                icon: 'question',
                showCancelButton: true,
                confirmButtonText: 'Ya',
                cancelButtonText: 'Batal',
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ route('admin.transaksi.cetaklabel.kosongkan') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.transaksi.cetaklabel.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
    ...
    @include('admin.transaksi.label.js_tambahdata')

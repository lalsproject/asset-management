...
@section('content')
    ...
    @include('admin.master.barang.modal')
    ...
    <script>
        ...
        function HapusData(id){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.barang.hapusdata') }}',
                        type: 'POST',
                        data: datanya
                    })
                    .then(response => {
        ...
        function HapusTerpilih(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ route('admin.master.barang.hapusdipilih') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.barang.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.barang.store') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {

...
@section('content')
    ...
    @include('admin.master.kondisi.modal')
...
@section('js')
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Kondisi");
            $('#pesan').html("");
            $('#deskripsi').val("");
            $('#uraian').val("");
        ...
        function EditData(id, deskripsi, uraian, warna){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Kondisi");
        ...
        function HapusData(id){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.kondisi.hapusdata') }}',
                        type: 'POST',
                        data: datanya
                    })
                    .then(response => {
        ...
        function HapusTerpilih(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ route('admin.master.kondisi.hapusdipilih') }}',
                        type: 'POST',
                        data:  datanya,
                    })
                    .then(response => {
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.kondisi.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.kondisi.store') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {

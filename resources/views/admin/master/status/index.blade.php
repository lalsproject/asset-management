...
@section('title', 'Master Status Aset')
...
@section('content')
    ...
    @include('admin.master.status.modal')
...
@section('js')
    <script>
        ...
        function EditData(id, deskripsi, warna){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Status Aset");
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.status.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.status.store') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {

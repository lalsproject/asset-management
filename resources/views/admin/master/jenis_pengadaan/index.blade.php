...
@section('title', 'Master Jenis Pengadaan')
...
@section('content')
    ...
    @include('admin.master.jenis_pengadaan.modal')
...
@section('js')
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Jenis Pengadaan");
            $('#pesan').html("");
            $('#kode').val("");
            $('#deskripsi').val("");
        ...
        function EditData(id, kode, deskripsi){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Jenis Pengadaan");
        ...
        function HapusData(id){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.jenis_pengadaan.hapusdata') }}',
                        type: 'POST',
                        data: datanya
                    })
                    .then(response => {
        ...
        function HapusTerpilih(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ route('admin.master.jenis_pengadaan.hapusdipilih') }}',
                        type: 'POST',
                        data:  datanya,
                    })
                    .then(response => {
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.jenis_pengadaan.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            if (deskripsi.value.trim() == "") {
                Swal.fire({
                            icon: 'error',
                            text: "Nama jenis_pengadaan belum diisi",
                            closeOnConfirm: true,
                            onAfterClose: (e) => {
                                   $("#deskripsi").focus();
                                },
            ...
            if (kode.value.trim() == "") {
                Swal.fire({
                            icon: 'error',
                            text: "Kode jenis_pengadaan belum diisi",
                            closeOnConfirm: true,
                            onAfterClose: (e) => {
                                   $("#kode").focus();
                                },
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.jenis_pengadaan.store') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {

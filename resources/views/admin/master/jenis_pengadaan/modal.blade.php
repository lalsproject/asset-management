        ...
        <div class="modal-dialog  modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title" id="modal-title">Jenis Pengadaan</h4>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group" id='nama_role'>
                        <p><b>Nama Jenis Pengadaan</b></p>
                        <input type="text" class="form-control" id='deskripsi' name='deskripsi' placeholder='Nama Jenis Pengadaan', maxlength=100>
                    </div>

...
@section('title', 'Master Jenis Maintenance')

@section('content_header')
    Master Jenis Maintenance
@stop
...
@section('content')
    ...
    @include('admin.master.jenis_maintenance.modal')
...
@section('js')
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Jenis Maintenance");
            $('#pesan').html("");
            $('#deskripsi').val("");
        ...
        function EditData(id, deskripsi, uraian, warna){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Jenis Maintenance");
        ...
        function HapusData(id){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.jenis_maintenance.hapusdata') }}',
                        type: 'POST',
                        data: datanya
                    })
                    .then(response => {
        ...
        function HapusTerpilih(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ route('admin.master.jenis_maintenance.hapusdipilih') }}',
                        type: 'POST',
                        data:  datanya,
                    })
                    .then(response => {
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.jenis_maintenance.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            if (deskripsi.value.trim() == "") {
                Swal.fire({
                            icon: 'error',
                            text: "Nama jenis_maintenance belum diisi",
                            closeOnConfirm: true,
                            onAfterClose: (e) => {
                                   $("#deskripsi").focus();
                                },
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.jenis_maintenance.store') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {

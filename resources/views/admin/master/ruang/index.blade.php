...
@section('content')
    ...
    @include('admin.master.ruang.modal')
...
@section('js')
    <script>
        ...
        function BuatBaru(){
            ...
            $('#modal-title').html("Buat Data Ruang");
            $('#pesan').html("");
            $('#kode').val("");
            $('#deskripsi').val("");
        ...
        function EditData(id, lokasi_id, kode, deskripsi){
            $('#pesan').html("");
            $('#modal-title').html("Edit Data Ruang");
        ...
        function HapusData(id){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.ruang.hapusdata') }}',
                        type: 'POST',
                        data: datanya
                    })
                    .then(response => {
        ...
        function HapusTerpilih(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url: '{{ route('admin.master.ruang.hapusdipilih') }}',
                        type: 'POST',
                        data:  datanya,
                    })
                    .then(response => {
        ...
        function LoadData(halaman) {
            ...
            $.ajax({
                type : 'POST',
                url  : '{{ route('admin.master.ruang.loaddatatable') }}',
                data : datanya,
                success: function(rv) {
                    var myObj = rv;
        ...
        function SimpanData(){
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return $.ajax({
                        url  : '{{ route('admin.master.ruang.store') }}',
                        type: 'POST',
                        data:  datanya
                    })
                    .then(response => {
